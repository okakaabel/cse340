...
-- For the Happy Employee account
UPDATE public.account 
SET account_type = 'Employee' 
WHERE account_email = 'happy@340.edu';

-- For the Manager User account
UPDATE public.account 
...
account_first_name character varying NOT NULL,
account_last_name character varying NOT NULL,
